...
<?	
	$videos = array(
		...
		array(
			...
			"text-image" => "/thumbs/vid-thumb-getlifted.png",
			"data-description" => "Soul singer and songwriter <a href='http://www.eboniegmusic.com/' target='_blank'>Ebonie G</a> performs 'Keep On Going' from her debut album 'I Am Beautiful Inspiration' as part of the <a href='https://www.youtube.com/user/getliftedLDN' target='_blank'>Get Lifted</a> Sessions series.</p>
			<p>Directed and edited by Joseph Madden</p>
			<p>Produced by Lewis Daniel for <a href='https://www.youtube.com/user/getliftedLDN' target='_blank'>Get Lifted TV</a></p>
			<p>Camera Operator 1: Joseph Madden</p>
			<p>Camera Operator 2/Stills Photographer: <a href='http://www.patricklarder.com/' target='_blank'>Patrick Larder</a></p>
			<p>Sound recorded and mixed by Lewis Daniel</p>
			<p>Executive Producers: Lewis Daniel & Adam Gray</p>"
		),

		array(
			"vimeo" => "121253734",
			"data-title" => "Ore - Femi Temowo | Get Lifted Sessions",
			"thumbnail" => "/thumbs/vid-thumb-femi-1.jpg",
			"text-image" => "/thumbs/vid-thumb-getlifted.png",
			"data-description" => "
			MOBO-nominated guitarist and former Music Director to Amy Winehouse, <a href='http://www.femiguitar.com/' target='_blank'>Femi Temowo</a>, sings 'Ore' as part of the <a href='https://www.youtube.com/user/getliftedLDN' target='_blank'>Get Lifted</a> Sessions series.</p>
			<p>Directed and edited by Joseph Madden</p>
			<p>Produced by Lewis Daniel for <a href='https://www.youtube.com/user/getliftedLDN' target='_blank'>Get Lifted TV</a></p>
			<p>Camera Operator 1: Joseph Madden</p>
			<p>Camera Operator 2: <a href='https://vimeo.com/ollieholder' target='_blank'>Ollie Holder</a>
			<p>Stills Photographer: <a href='http://www.patricklarder.com/' target='_blank'>Patrick Larder</a></p>
			<p>Sound recorded and mixed by Lewis Daniel</p>
			<p>Executive Producers: Lewis Daniel & Adam Gray</p>"
		),
